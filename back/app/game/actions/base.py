...
class Action(GameBaseModel):
    ...
    def to_dict(self, state: GameState | None = None) -> dict[str, Any]:
...
_CARD_ID_TO_NAME = {
    ...
    "secondary_target_card_id": "secondary_target_name",
    "cost_card_id": "cost_card_name",
    "swap_with_supporting_card_id": "swap_with_supporting_card_name",
    "graveyard_card_id": "graveyard_card_name",
    "source_card_id": "source_card_name",
}
